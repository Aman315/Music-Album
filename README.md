...
Analyzed sales data to identify top-performing artists and genres by revenue, generating insights to optimize the music catalog.
Determined the most popular music genre for each country and the customer who spent the most money, enabling targeted marketing campaigns and improved customer segmentation.
Developed queries to analyze employee performance based on sales metrics, identifying the top-selling agent and contributing to operational efficiency.
Extracted and manipulated data to calculate average song lengths and identify tracks longer than the mean, demonstrating proficiency in data manipulation and filtering techniques.
Presented data findings in a clear, concise format, translating complex SQL query results into actionable business recommendations.
This project demonstrates strong analytical skills and practical experience in using SQL for real-world data analysis tasks. 
